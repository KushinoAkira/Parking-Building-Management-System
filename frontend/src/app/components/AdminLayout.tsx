...
export function AdminLayout() {
  ...
  const navigation = useMemo(
    () => [
      ...
      { name: t("nav.roles"), href: "/admin/roles", icon: ShieldCheck },
      { name: t("nav.config"), href: "/admin/config", icon: ServerCog },
    ],
    [t],
  );
        ...
        <div className="flex-1 flex justify-center max-w-xl px-4 hidden sm:flex">
          <div className="w-full relative">
            ...
            <input
              ...
              placeholder={t("common.searchAdmin")}
            />
          </div>
        </div>
          ...
          <div className="flex items-center gap-2.5">
            <div className="flex items-center gap-2 cursor-pointer group">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-xs text-gray-400 dark:text-gray-500">{t("role.Admin")}</p>
              </div>
            </div>
            <button
